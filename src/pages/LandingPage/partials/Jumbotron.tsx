// TAK UBAH SITIK YOO aowkaowkoawkoawk
        ...
        <div className="absolute z-20 w-full h-full">
          <div className="relative max-w-7xl flex flex-col items-center justify-center h-full gap-5 mx-auto">
            ...
            <div className="z-20 absolute bottom-0 w-full flex p-12 justify-center items-center">
              <a href="#about" className="text-white text-xl justify-center items-center animate-bounce bg-indigo-400 px-5 py-2 rounded-full inline-flex gap-2">
                Scroll Down{" "}
                <div>
                  <svg
